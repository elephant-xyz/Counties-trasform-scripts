...
const propertyTypeMapping = [
  ...
  {
    "property_usecode": "ANIMAL CLINIC/KENNEL",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "BED & BREAKFAST",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "COMMON PROPERTY",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "CONSERVATION EASEMEN",
  ...
  {
    "property_usecode": "CULTURAL GROUPS",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "DRY CLEANER/LAUNDRO",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "HEALTH/FITNESS",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "Recreational",
  ...
  {
    "property_usecode": "MINI WAREHOUSES",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "MOBILE HOME(NO ASMT)",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": "ManufacturedHousing",
    "property_usage_type": "Residential",
  ...
  {
    "property_usecode": "MULTI-FAMILY 10 LESS",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
  ...
  {
    "property_usecode": "MUNICIPAL (PSJ)",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "GovernmentProperty",
  ...
  {
    "property_usecode": "MUNICIPAL (WEWA)",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "GovernmentProperty",
  ...
  {
    "property_usecode": "OTHER STRUCTURE",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "Unknown",
  ...
  {
    "property_usecode": "P.U.D. W/MARINA",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "Residential",
  ...
  {
    "property_usecode": "PASTURELAND 6",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "SINGLE FAMILY-MOD",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": "SingleFamilyDetached",
    "property_usage_type": "Residential",
  ...
  {
    "property_usecode": "STORES, 1 ST (DRUG)",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "RetailStore",
  ...
  {
    "property_usecode": "STORM WATER MNGT FAC",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "SUBMERGED LANDS",
    "ownership_estate_type": "FeeSimple",
    "build_status": "VacantLand",
    "structure_form": null,
  ...
  {
    "property_usecode": "TIMBER SITE INDEX 55",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "TimberLand",
  ...
  {
    "property_usecode": "TIMBER SITE INDEX 60",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "TimberLand",
  ...
  {
    "property_usecode": "TIMBER SITE INDEX 65",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "TimberLand",
  ...
  {
    "property_usecode": "TIMBER SITE INDEX 70",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "TimberLand",
  ...
  {
    "property_usecode": "TRAVEL TRAILER",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
...
const OWNER_MAILING_ADDRESS_SELECTOR = "#ctlBodyPane_ctl02_ctl01_rptOwner_ctl00_lblOwnerAddress";
...
function mapPropertyTypeFromUseCode(code) {
  ...
  // }
  for (const [key, value] of Object.entries(propertyTypeByUseCode)) {
...
function writePersonCompaniesSalesRelationships(parcelId, sales, hasOwnerMailingAddress) {
  ...
  // First, collect only owners that will have relationships (on sale dates or current with mailing address)
  const ownersWithRelationships = new Set();

  // Collect owners from sale dates
  sales.forEach((rec) => {
    const d = parseDateToISO(rec.saleDate);
    const ownersOnDate = ownersByDate[d] || [];
    ownersOnDate.forEach((o) => {
      if (o.type === "person") {
        const k = `person:${(o.first_name || "").trim().toUpperCase()}|${(o.last_name || "").trim().toUpperCase()}`;
        ownersWithRelationships.add(k);
      } else if (o.type === "company" && (o.name || "").trim()) {
        const k = `company:${(o.name || "").trim().toUpperCase()}`;
        ownersWithRelationships.add(k);
      }
    });
  });

  // Collect current owners if they have mailing address
  ...
  // Now create person files only for those with relationships
  const personMap = new Map();
  Object.values(ownersByDate).forEach((arr) => {
    (arr || []).forEach((o) => {
      if (o.type === "person") {
        const k = `${(o.first_name || "").trim().toUpperCase()}|${(o.last_name || "").trim().toUpperCase()}`;
        const relationshipKey = `person:${k}`;
        // Only include if this person will have a relationship
        if (ownersWithRelationships.has(relationshipKey)) {
          if (!personMap.has(k))
            personMap.set(k, {
  ...
  // Now create company files only for those with relationships
  const companyNames = new Set();
  Object.values(ownersByDate).forEach((arr) => {
    (arr || []).forEach((o) => {
      if (o.type === "company" && (o.name || "").trim()) {
        const companyName = (o.name || "").trim().toUpperCase();
        const relationshipKey = `company:${companyName}`;
        // Only include if this company will have a relationship
        if (ownersWithRelationships.has(relationshipKey)) {
...
function extractOwnerMailingAddress($) {
  const ownerAddressText = textOf($(OWNER_MAILING_ADDRESS_SELECTOR));
  if (ownerAddressText) {
    return ownerAddressText.replace(/  +/g, ' ');
  }
  return null;
}
