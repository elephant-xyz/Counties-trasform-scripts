...
function main() {
  ...
  const parcelIdentifier = seed.parcel_id || parcelId || null;
  ...
  writeJSON(path.join(outDir, "geometry.json"), geometry);
  ...
  writeJSON(path.join(outDir, "relationship_address_has_geometry.json"), relAddressGeometry);
