...
/**
 * Minimal 2 model that mirrors the Elephant Geometry class.
 */
class Geometry {
...
function main() {
  ...
  const geometry = {
    ...
    request_identifier: parcelIdentifier || (seed && seed.parcel_id) || "",
  ...
  // Create parcel.json
  const parcel = {
    source_http_request: (seed && seed.source_http_request) || {
      method: "GET",
      url: (seed && seed.url) || ""
    },
    request_identifier: (seed && seed.request_identifier) || parcelIdentifier || "",
