...
function main() {
  ...
  for (const year of years) {
    ...
    const taxObj = {
      tax_year: year,
      property_assessed_value_amount: typeof marketVal === 'number' ? marketVal : 0,
      property_market_value_amount: typeof marketVal === 'number' ? marketVal : 0,
      property_building_amount: impVal || null,
      property_land_amount: landVal || null,
      property_taxable_value_amount: typeof marketVal === 'number' ? marketVal : 0,
