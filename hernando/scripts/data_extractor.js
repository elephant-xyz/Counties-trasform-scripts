...
function main() {
  ...
  const parcelIdentifier = parcelId || seed.parcel_id || null;
  ...
  const geometry = {
    ...
    latitude: unnorm && unnorm.latitude ? Number(unnorm.latitude) : null,
    longitude: unnorm && unnorm.longitude ? Number(unnorm.longitude) : null
  };
