...
function main() {
  ...
  // Structure data is handled by structureMapping.js script
  // which writes to owners/structure_data.json
  // We do not create a standalone structure.json file in the data directory
  // as there is no relationship class to connect property to structure
