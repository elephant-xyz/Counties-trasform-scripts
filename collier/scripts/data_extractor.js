...
function main() {
  ...
  // Complex table cell selectors for book/page links (sales)
  $("table.clsWide > tfoot.clsNoBorderBox > tr:nth-child(2) > td.clsLabelnt:nth-child(2) > a").text();
  $("table.clsWide > tfoot.clsNoBorderBox > tr:nth-child(5) > td.clsLabelnt:nth-child(2) > a").text();
  $("table.clsWide > tfoot.clsNoBorderBox > tr:nth-child(6) > td.clsLabelnt:nth-child(2) > a").text();
  $("table.clsWide > tfoot.clsNoBorderBox > tr:nth-child(7) > td.clsLabelnt:nth-child(2) > a").text();
  ...
  // Tax breakdown (TaName, Millage, Tax) selectors (1-11)
  for (let i = 1; i <= 11; i++) {
    $(`#TaName${i}`).text();
    $(`#Millage${i}`).text();
    $(`#Tax${i}`).text();
  ...
  // Historical value selectors (Land, Improvements, Total) (2-5)
  for (let i = 2; i <= 5; i++) {
  ...
  // Historical taxable value selectors (2-5)
  for (let i = 2; i <= 5; i++) {
    $(`#HistoryCountyTaxableValue${i}`).text();
    $(`#HistorySchoolTaxableValue${i}`).text();
  }

  // Historical millage selectors (1-5)
  for (let i = 1; i <= 5; i++) {
  ...
  // Historical tax totals selectors (2-5)
  for (let i = 2; i <= 5; i++) {
