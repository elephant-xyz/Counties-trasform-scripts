...
const propertyTypeMapping = [
  ...
  {
    "property_usecode": "CHURCH/S FAM RES",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "COUNTY VOTE PRECINT",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "GovernmentProperty",
  ...
  {
    "property_usecode": "CROPLAND CLS1",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "NON BUILDABLE",
    "ownership_estate_type": "FeeSimple",
    "build_status": "VacantLand",
    "structure_form": null,
  ...
  {
    "property_usecode": "OFFCE BLD MULTI-STY",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "OFFICE BLD, NON_PRO, 1 STY",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "OfficeBuilding",
  ...
  {
    "property_usecode": "PASTURE/CROPLAND",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "PUBLIC SCHOOLS,XF",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "PublicSchool",
  ...
  {
    "property_usecode": "REPAIR SHOP EXCLUDE AUTO REPAIR",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "Commercial",
  ...
  {
    "property_usecode": "SOLAR UTILITIES",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "VACANT COMM, XF",
    "ownership_estate_type": "FeeSimple",
    "build_status": "VacantLand",
    "structure_form": null,
    "property_usage_type": "Commercial",
  ...
  {
    "property_usecode": "VACANT RIV FF",
    "ownership_estate_type": "FeeSimple",
    "build_status": "VacantLand",
    "structure_form": null,
    "property_usage_type": "Residential",
  ...
  {
    "property_usecode": "VEH SALE AND/OR REPAIR",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
  ...
  {
    "property_usecode": "WATER DIST IMP",
    "ownership_estate_type": "FeeSimple",
    "build_status": "Improved",
    "structure_form": null,
    "property_usage_type": "Utility",
  ...
  {
    "property_usecode": "WATER DIST VAC",
    "ownership_estate_type": "FeeSimple",
    "build_status": "VacantLand",
    "structure_form": null,
    "property_usage_type": "Utility",
...
const HISTORICAL_VALUATION_TABLE_SELECTOR = null;
...
function extractSales($) {
  ...
  rows.each((i, tr) => {
    ...
    let instrumentNumber = textOf($(tds[5]));
    ...
    if (instrumentNumber) {
      instrumentNumber = instrumentNumber.split("\n")[0];
    }
    let link = null;
    if (book && page) {
      link = $(tds[4]).find("a").last().attr("href") || null;
    } else if (instrumentNumber) {
      link = $(tds[5]).find("a").last().attr("href") || null;
    }
...
function main() {
  ...
  if (geometryCsv) {
    ...
    // Fallback: create geometry from unnormalized address if no CSV
    ...
    if (latitude && longitude) {
      ...
      createParcelGeometries([coordinate]);
    }
  }
  let struct = null;
  if (structureData) {
