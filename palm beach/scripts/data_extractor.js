...
async function main() {
  ...
  removeFileIfExists(path.join(dataDir, "relationship_property_has_address.json"));
  removeFileIfExists(path.join(dataDir, "relationship_address_has_fact_sheet.json"));
}
